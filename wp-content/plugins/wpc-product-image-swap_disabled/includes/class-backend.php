		...
		function style_settings( $product_id = 0 ) {
            ...
            <tr class="wpcis_hide_if_type wpcis_tr_show_if_type_slider">
                ...
                <td>
                    ...
                    <span class="description"><?php esc_html_e( 'Pause the slideshow when hovering over slider, then resume when no longer hovering (for Autoplay mode only).', 'wpc-product-image-swap' ); ?></span>
                </td>
            </tr>
            <tr class="wpcis_hide_if_type wpcis_tr_show_if_type_slider">
